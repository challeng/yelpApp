...
- (AFHTTPRequestOperation *)searchWithTerm:(NSString *)term
    ...
    NSMutableDictionary *defaultParameters = [@{@"term": term,
    ...
    if (categories && categories.count > 0) {
        defaultParameters[@"category_filter"] = [categories componentsJoinedByString:@","];
    }
    
    if (hasDeal) {
        defaultParameters[@"deals_filter"] = [NSNumber numberWithBool:hasDeal];
    }
